...
[source,java]
----
include::kafka/src/test/groovy/docs/producer/fallback/MessageClientFallback.java[tags=imports, indent=0]

include::kafka/src/test/groovy/docs/producer/fallback/MessageClientFallback.java[tags=clazz, indent=0]
----
