...
class KafkaReactiveExecutorListenerSpec extends AbstractKafkaContainerSpec {

    public static final String TOPIC_NAME = "KafkaReactiveExecutorListenerSpec-books"
    ...
    @Requires(property = 'spec.name', value = 'KafkaReactiveExecutorListenerSpec')
    @KafkaClient(acks = ALL)
    @Topic(KafkaReactiveExecutorListenerSpec.TOPIC_NAME)
