...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-kafka). This is required before any of your code or pull-requests are accepted.
...
Micronaut Kafka currently requires JDK 8.

## IDE Setup

Micronaut Kafka can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut Kafka tests currently require Docker to be installed.
